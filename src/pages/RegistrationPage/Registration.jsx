                ...
                <div className={classes.loginFormContainer}>
                    <form className={classes.loginForm} onSubmit={handleSubmit}>
                        ...
                        <MyButton variant="primary" type="submit" disabled={loading}>
                            {loading ? <Spin style={{ color: 'white' }} indicator={<LoadingOutlined spin />} /> : 'Зарегистрироваться'}
                        </MyButton>
                    </form>
                    <div className={classes.touContainer}>
                        <div className={classes.touContainerText}>
                            Регистрируясь, Вы даете согласие на обработку Ваших персональных данных, а также соглашаетесь с правилами использования сервиса. <a href="#">Подробнее...</a>
                        </div>
                    </div>
                </div>
