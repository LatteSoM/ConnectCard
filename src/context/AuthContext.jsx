...
export const AuthProvider = ({ children }) => {
  ...
  const fetchCurrentUser = async (token = null) => {
    ...
    try {
      const response = await axios.get("http://127.0.0.1:8000/auth/current_user", {
  ...
  const refreshAccessToken = async () => {
    ...
    try {
      const response = await axios.post("http://127.0.0.1:8000/auth/refresh", storedRefreshToken, {
